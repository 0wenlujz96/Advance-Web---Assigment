    ...
    <div>
      <?php
        if(isset($_POST["created"])) {
          ...
          $sql = "INSERT INTO users(fname, lname, uname, email, password) VALUE(?,?,?,?,?)";
          $stmtinsert = $conn->prepare($sql);
          $result = $stmtinsert->execute([$fname, $lname, $uname, $email, $password]);  
      ...
      <div class="boxLogin py-4 text-white container">
        ...
        <div class="row">
          <div class="col-ms-2">
            ...
            <br>
            <input class="form-control btn btn-primary" type="submit" name="created" value="Submit">
          </div>
        </div>
